...
__device__ void gemvt_kernel_calc_xAy(int m,
                                  int n,
                                  U alpha,
                                  const T *x,
                                  int lda,
...
__global__ void gemvt_kernel_xAy(int m,
                             int n,
                             U alpha_device_host,
                             const V *xa,
                             int lda,
...
void rocblas_gemv_template_xAy(hipStream_t p_stream, const V *x, const V *A,  W *y, int m, int n, int k, U alpha, U beta)
{
    ...
    hipLaunchKernelGGL((gemvt_kernel_xAy<NB>),
                       gemvt_grid,
                       gemvt_threads,
                       0,
                       p_stream,
...
// Ax = y
template <int NB_X, typename T, typename U>
__device__ void gemvt_kernel_calc_Axy(int m,
                                  int n,
                                  U alpha,
                                  const T *A,
                                  int lda,
...
template <int NB_X, typename U, typename V, typename W>
__global__ void gemvt_kernel_Axy(int m,
                             int n,
                             U alpha_device_host,
                             const V *Aa,
                             int lda,
...
void rocblas_gemv_template_Axy(hipStream_t p_stream, const V *A, const V *x,  W *y, int m, int n, int k, U alpha, U beta)
{
    ...
    hipLaunchKernelGGL((gemvt_kernel_Axy<NB>),
                       gemvt_grid,
                       gemvt_threads,
                       0,
                       p_stream,

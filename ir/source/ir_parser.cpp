...
IRParser::IRParser() {
    ...
    nn_node_parse_func_map_ = {
        ...
        {IR::NNNode::AnyType_AtenArangeNode, &IRNNNodeParser::parseNNNode<IR::NNNode::AnyType_AtenArangeNode>},
        ...
        {IR::NNNode::AnyType_AtenIndexSelectNode, &IRNNNodeParser::parseNNNode<IR::NNNode::AnyType_AtenIndexSelectNode>},

...
IRParser::IRParser() {
    ...
    nn_node_parse_func_map_ = {
        ...
        {IR::NNNode::AnyType_AtenTo1Node, &IRNNNodeParser::parseNNNode<IR::NNNode::AnyType_AtenTo1Node>},
        {IR::NNNode::AnyType_AtenTo2Node, &IRNNNodeParser::parseNNNode<IR::NNNode::AnyType_AtenTo2Node>},

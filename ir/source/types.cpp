...
std::string convertLayerTypeToString(LayerType type)
{
    ...
    converter.insert({LayerType::ATENEINSUM, "aten::einsum"});
    ...
    converter.insert({LayerType::ATENFULLLIKE, "aten::full_like"});
    ...
    converter.insert({LayerType::ATENISINF, "aten::isinf"});
    ...
    converter.insert({LayerType::ATENLE, "aten::le"});
    ...
    converter.insert({LayerType::ATENONEHOT, "aten::one_hot"});
    ...
    converter.insert({LayerType::ATENPERMUTE, "aten::permute"});
    ...
    converter.insert({LayerType::ATENRSQRT, "aten::rsqrt"});
    ...
    converter.insert({LayerType::ATENTO3, "aten::to3"});
    ...
    converter.insert({LayerType::ATENWHERE, "aten::where"});

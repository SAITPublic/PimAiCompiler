...
aten_ops_no_attr_dict = {
    ...
    'AtenCopyNode' : IR.NNNode.AtenCopyNode.AtenCopyNode(),
    'AtenDeriveIndexNode' : IR.NNNode.AtenDeriveIndexNode.AtenDeriveIndexNode(),
    'AtenDimNode' : IR.NNNode.AtenDimNode.AtenDimNode(),
    'AtenDivNode' : IR.NNNode.AtenDivNode.AtenDivNode(),
    'AtenEmbeddingNode' : IR.NNNode.AtenEmbeddingNode.AtenEmbeddingNode(),
    'AtenEqNode' : IR.NNNode.AtenEqNode.AtenEqNode(),
    'AtenFormatNode' : IR.NNNode.AtenFormatNode.AtenFormatNode(),

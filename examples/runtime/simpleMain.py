...
def test_hwr_inference(model_ir_file : str, input_tensor_file : str):
    # Prepare inputs
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--graph_ir_file', type=str, help='IR file generated by GraphGen', required=True)
    args = arg_parser.parse_args()
    
    assert os.path.exists(args.graph_ir_file)
    if args.model_kind == 'RNNT':
        # Inference RNNT
        rnnt_ir_file = args.graph_ir_file

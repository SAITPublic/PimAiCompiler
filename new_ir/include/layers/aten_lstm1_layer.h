...
class AtenLSTM1Layer : public NNLayer {
 public:
    ...
    explicit AtenLSTM1Layer(const AtenLSTM1Layer &aten_lstm1_layer) : NNLayer(aten_lstm1_layer) {
        this->setAttr(aten_lstm1_layer._has_biases, aten_lstm1_layer._num_layers,
                      aten_lstm1_layer._dropout, aten_lstm1_layer._train,
                      aten_lstm1_layer._bidirectional, aten_lstm1_layer._batch_first);
    }

    virtual ~AtenLSTM1Layer() {}

    virtual std::shared_ptr<NNLayer> clone() {
        return std::shared_ptr<AtenLSTM1Layer>(new AtenLSTM1Layer(*this));
    }
 ...
 public:
    ...
    void setBatchFirst(int batch_first) {
        this->_batch_first = batch_first;
    }

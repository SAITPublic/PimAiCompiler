...
class NNLayer {
 public:
    ...
    virtual std::shared_ptr<NNLayer> clone() {
        return  std::shared_ptr<NNLayer>(new NNLayer(*this));
    }
    ...
    void addInSTensorID(uint32_t input_id) {
        in_shape_tensors_.push_back(input_id);
    }
    ...
    std::vector<uint32_t> getInSTensorID() const {
        return in_shape_tensors_;
    }

    void setInSTensorID(std::vector<uint32_t> in_shape_tensors) {
        in_shape_tensors_ = in_shape_tensors;
    }

    void addOutSTensorID(uint32_t output_id) {
        out_shape_tensors_.push_back(output_id);
    }
    ...
    std::vector<uint32_t> getOutSTensorID() const {
        return out_shape_tensors_;
    }

    void setOutSTensorID(std::vector<uint32_t> out_shape_tensors) {
        out_shape_tensors_ = out_shape_tensors;
    }

    void addDataTensor(uint32_t id) {
        data_tensors_.push_back(id);
    }
    ...
    std::vector<uint32_t> getDTensors() const {
